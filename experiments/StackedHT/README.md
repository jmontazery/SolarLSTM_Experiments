...
## Overview
This folder contains the full experiment for the **StackedHT** model used in the solar power forecasting study.
...
## Contents
- `StackedHT.py` — main script containing preprocessing, training, evaluation, and plotting
