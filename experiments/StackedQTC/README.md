...
## Overview
This folder contains the full experiment for the **StackedQTC** model used in the solar power forecasting study.
...
## Contents
- `StackedQTC.py` — main script containing preprocessing, training, evaluation, and plotting
