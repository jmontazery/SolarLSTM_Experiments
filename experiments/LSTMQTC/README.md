...
## Overview
This folder contains the full experiment for the **LSTMQTC** model used in the solar power forecasting study.
...
## Contents
- `LSTMQTC.py` — main script containing preprocessing, training, evaluation, and plotting
